...
def main(req):
    ...
    AZURE_OPENAI_API_VERSION = os.environ.get("AZURE_OPENAI_API_VERSION") or "2023-06-01-preview" # this may change in the future
    ...
    if bool(USE_LANGCHAIN):
        ...
        llm = AzureOpenAI(deployment_name=AZURE_OPENAI_CHATGPT_DEPLOYMENT, temperature=0.3, openai_api_key=AZURE_OPENAI_KEY, openai_api_version=AZURE_OPENAI_API_VERSION)
